                ...
                <div class="grid gap-8 lg:grid-cols-2 xl:grid-cols-3">
                    @forelse ($aspirations as $aspiration)
                        <article
                            ...
                            <div>
                                <button class="text-yellow-600 mt-3 text-sm" data-modal-target="detail-modal-{{ $loop->iteration }}"
                                    ...
                                    <div class="relative bg-white rounded-lg shadow">
                                        ...
                                        <div
                                            ...
                                            <div>
                                                ...
                                                <p class="text-sm">{{ $aspiration->nim }}</p>
                                            </div>
                                            <button type="button"
                                            ...
                                            <div class="overflow-x-auto">
                                                <table class="text-left">
                                                    ...
                                                    <tbody>
                                                        <tr class="flex gap-1">
                                                            <th>Jenis:</th>
                                                            <td>{{ $aspiration->aspirationType->name }}</td>
                                                        </tr>
                                                        <tr class="flex gap-1">
                                                            <th>Fakultas:</th>
                                                            <td>{{ $aspiration->faculty->name }}</td>
                                                        </tr>
                                                        <tr class="flex gap-1">
                                                            <th>Angkatan:</th>
                                                            <td>{{ $aspiration->generation }}</td>
                                                        </tr>
                                                        <tr class="flex gap-1">
                                                            <th>No. Telp:</th>
                                                            <td>{{ $aspiration->telephone }}</td>
                                                        </tr>
                                                        <tr class="flex gap-1">
                                                            <th>Alamat:</th>
