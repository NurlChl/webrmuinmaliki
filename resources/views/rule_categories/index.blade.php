                                                    ...
                                                    <div class="p-4 md:p-5 space-y-4">
                                                        <div>
                                                            ...
                                                            <input type="text" name="name" id="name"
                                                                autocomplete="off"
                                                                value="{{ old('name', $rule_category->name) }}"
                            ...
                            @forelse ($rule_categories as $rule_category)
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <td class="hidden sm:block px-6 py-4">
                                        {{ $rule_category->created_at->format('d-m-Y') }}
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex">
                                            {{-- <a href="{{ route('faculties.edit', $rule_category) }}"
                                            ...
                                            <form onsubmit="return confirm('Yakin hapus anggota ini?')"
                                                action="{{ route('faculties.destroy', $rule_category->id) }}" method="POST">
                    ...
                    <div id="accordion-flush" data-accordion="collapse"
                        ...
                        <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                <p class="mb-2 text-gray-500 dark:text-gray-400">Untuk menambah kategori anggota, klik tombol
                                    di pojok kanan atas di dalam tabel. Lalu isi dan lengkapi semua yang harus diisi. Pastikan anda
