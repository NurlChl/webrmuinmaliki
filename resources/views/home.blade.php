    ...
    <x-container class="flex flex-col mx-auto max-w-3xl lg:w-full md:mt-10 lg:max-w-7xl bg-white p-5">
        <div class="flex flex-col w-full lg:flex-row gap-10 mx-auto">
            <section class="max-w-screen-md basis-3/4 flex flex-col gap-7 sm:gap-10 w-full">
                ...
                @if ($posts->count() > 2)
                    <div>
                        <h2 class=" mb-4 text-base text-red-600 font-bold uppercase">Berita Trending</h2>
                        <div id="default-carousel" class="relative" data-carousel="slide">
                            ...
                            <button type="button"
                                ...
                                data-carousel-prev>
                                <span
                                    class="inline-flex items-center justify-center w-5 h-5 sm:w-10 sm:h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                                    <svg class="w-2 h-2 sm:w-4 sm:h-4 text-white dark:text-gray-800 rtl:rotate-180"
            ...
            <section class="flex flex-col gap-10 basis-1/3 w-full">
                    ...
                    <div>
                        @forelse ($rulesByCategory as $ruleCategory => $rules)
                            <div class="group/category py-3 first:py-0">
                                <div class="mb-3 first:mt-0 text-left w-full bg-amber-900 text-white py-2 pl-2 sm:pl-5 pr-10 text-xs sm:text-sm font-semibold uppercase shadow-md"
                                    style="clip-path: polygon(0% 0%, 60% 0%, 55% 50%, 60% 100%, 0% 100%);">
                                    {{ $ruleCategory }}
                                </div>
                                @forelse ($rules as $rule)
                                    <a href="{{ $rule->file }}" target="_blank"
                                        class="block px-3 sm:px-5 py-3 border-b last:border-b-0  border-zinc-200 ">
                                        <div class="flex flex-row gap-5 group/rule">
                                            <div>
                                                <svg class="w-7 h-7 mt-1.5 text-amber-400 group-hover/rule:text-amber-600 transition ease-in-out duration-300"
                                ...
                                @empty
                                    <div class="px-2 py-3 text-center">
                                        <svg class="w-10 h-10 mx-auto text-gray-800 dark:text-white"
                                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            viewBox="0 0 24 24">
                ...
                <div class="p-5 bg-white rounded-lg shadow-lg border border-emerald-300">
                    <div class="flex flex-row mb-10 bg bg-emerald-50 rounded-full">
                        <div class="py-3 px-7 sm:px-10 bg bg-emerald-500 rounded-full mr-5">
                            <svg class="w-5 h-5 sm:w-6 sm:h-6 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <h2 class="items-center my-auto text-lg font-bold uppercase">Peraturan</h2>
                    </div>
