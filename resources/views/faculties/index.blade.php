<x-app-layout>
    ...
    @slot('tittle', 'Fakultas')


    <x-side-nav>
        <section class="bg-white dark:bg-gray-900">
            <div
                class="flex flex-col lg:flex-row gap-5 py-8 px-2 sm:py-8 sm:px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div
                    ...
                    <table class="relative w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        <caption class="p-5 text-lg font-semibold text-left rtl:text-right text-gray-900 bg-white">
                            ...
                            <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Berikut adalah list
                                dari
                                fakultas yang akan dijadikan opsi pengisian form.</p>
                        </caption>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex gap-2">
                                            <div class="w-5 h-5 rounded-full bg-{{ $faculty->color }}-100"></div>
                                            <span>{{ $faculty->color }}</span>
                                        </div>
                                    </td>
                    ...
                    <div id="accordion-flush" data-accordion="collapse"
                        ...
                        <h2 id="accordion-flush-heading-1">
                            <button type="button"
                                ...
                                <span class="text-start">Gimana cara tambah Fakultas?</span>
                        ...
                        <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                <p class="mb-2 text-gray-500 dark:text-gray-400">Untuk menambah Fakultas, klik tombol
                        ...
                        <h2 id="accordion-flush-heading-3">
                            <button type="button"
                                ...
                                <span class="text-start">Gimana cara edit Fakultas?</span>
                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="M9 5 5 1 1 5" />
                        ...
                        <h2 id="accordion-flush-heading-2">
                            <button type="button"
                                ...
                                <span class="text-start">Ketentuan warna?</span>
                                <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                        stroke-width="2" d="M9 5 5 1 1 5" />
                        ...
                        <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                <p class="mb-2 text-gray-500 dark:text-gray-400">Berikut adalah warna-warna yang dapat
                                    di pilih untuk masing-masing Fakultas. Setiap Fakultas sebisa mungkin tidak memakai
                                    warna yang sama.</p>
                                <p class="text-gray-500 leading-7"><span
                                        class="text-blue-800 bg-blue-100 px-2 rounded-md">blue</span>, <span
                                        class="text-green-800 bg-green-100 px-2  rounded-md">green</span>, <span
                                        class="bg-yellow-100 px-2  rounded-md">yellow</span>, <span
                                        class="bg-purple-100 px-2  rounded-md">purple</span>, <span
                                        class="bg-pink-100 px-2  rounded-md">pink</span>, <span
                                        class="bg-amber-100 px-2  rounded-md">amber</span>, <span
                                        class="bg-lime-100 px-2  rounded-md">lime</span>, <span
                                        class="bg-teal-100 px-2  rounded-md">teal</span>, <span
                                        class="bg-emerald-100 px-2  rounded-md">emerald</span>, <span
                                        class="bg-cyan-100 px-2  rounded-md">cyan</span>, <span
                                        class="bg-sky-100 px-2  rounded-md">sky</span>, <span
                                        class="bg-indigo-100 px-2  rounded-md">indigo</span>, <span
                                        class="bg-violet-100 px-2  rounded-md">violet</span>, <span
                                        class="bg-fuchsia-100 px-2  rounded-md">fuchsia</span>, dan <span
                                        class="bg-rose-100 px-2  rounded-md">rose</span>.</p>
                            </div>
                        </div>
                    </div>
